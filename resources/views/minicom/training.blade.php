        ...
        <div class="flex justify-between items-center mb-4">
            ...
            <div id="formContainer"
                ...
                <div class="bg-white p-6 rounded shadow-lg w-full max-w-md mx-auto">
                    <h2 class="text-2xl font-semibold mb-4">Add New Training</h2>
                    <form method="POST" action="/minicom/training" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            <label for="video" class="block text-sm font-medium text-gray-700">Upload
                                Video</label>
                            <input type="file" name="file" id="video" class="mt-1 p-2 w-full border rounded">
                        </div>
        ...
        <table class="min-w-full bg-white">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="py-2 px-4 border-b"><a href="/minicom/training-details/{{$training->id}}"
                            class="text-blue-500 hover:underline">click here</a>
                    </td>
                    <td class="py-2 px-4 border-b">
                        <form action="{{ route('minicom.training.destroy', $training->id) }}" method="POST"
