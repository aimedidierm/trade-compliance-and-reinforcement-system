...
<main class="container mx-auto py-8 px-6">
    <div class="flex gap-6 mb-8">
        ...
        <div class="card flex-1" style="flex: 0 0 68%;">
            <h2 class="text-lg font-bold mb-4">Exporters management</h2>
            @if($errors->any())
                ...
                <tbody>
                    @foreach ($users as $user)<tr>
                        ...
                        <td class="py-2 px-4 border-b">
                            ...
                            <a type="button" href="/minicom/users/approve/{{$user->id}}"
                            ...
                            <a type="button" href="/minicom/users/reject/{{$user->id}}"
                            ...
                            @endif
                            <a type="button" href="/minicom/users/delete/{{$user->id}}"
                                class="text-white bg-red-700 hover:bg-red-800 focus:outline-none focus:ring-4 focus:ring-red-300 font-medium rounded-full text-sm px-2 py-1 text-center me-1 mb-1 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">Delete
                            </a>
                        </td>
                    </tr>
                    @endforeach
