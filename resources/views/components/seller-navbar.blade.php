        ...
        <div class="flex items-center">
            <nav class="flex space-x-4">
                ...
                <a href="/seller/products"
                    class="flex breadcrumb-item {{ request()->is('seller/products') || request()->is('seller/products/sales') || request()->is('seller/products/shipment') || request()->is('seller/products/reporting') || request()->is('seller/products/declaration') ? 'text-orange-400' : 'text-gray-500' }}">
                    <span class="material-symbols-outlined">
                        package_2
                    </span>
